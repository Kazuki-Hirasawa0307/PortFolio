...
import dao.SalarySelectDAO;
import model.TimeListBean;
import testdb.SalaryTotal;
...
//－－－－－－－－－－－－－各変数をjspへ転送－－－－－－－－－－－－－－－－－－－－－
			...
			request.setAttribute("paidvacation", returnAb.getAbsence());		//欠勤日数
			request.setAttribute("absence", returnAb.getPaidvacation());		//有給日数
